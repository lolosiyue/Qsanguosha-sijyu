...
> 此版已完成線上部署與一局 05P 託管完整對局，見[線上驗收報告](google-sheets-room-trust-acceptance-20260916.md)。
...
> 線上腳本更新及讀回一致，對局內查詢仍待驗收，見[詳情檢查點](google-sheets-details-validation-20260916.md)。
