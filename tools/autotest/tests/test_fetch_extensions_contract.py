...
FIXTURE_FILES = {
    ...
    "ai/mode-ai.lua": "-- mode policy\n",
    # The isolated core and a package handler: the runtime loads the declared core
    # by default and the fetcher refuses a repository that cannot supply them, so a
    # fixture with only one of them is not a repository the engine could boot from.
    "ai/isolated/ask-for-use-card.lua": "-- isolated\n",
    "ai/isolated/ask-for-choice.lua": "-- isolated choice\n",
    "ai/isolated/decision-core.lua": "-- isolated core\n",
    "ai/isolated/retrial.lua": "-- isolated retrial\n",
    "ai/isolated/strategy-hooks.lua": "-- isolated hooks\n",
    "ai/isolated/event-intention.lua": "-- isolated events\n",
    "ai/isolated/standard-ai.lua": "-- isolated standard\n",
...
EXPECTED = {
    ...
    "ai/mode-ai.lua": "lua/ai/mode-ai.lua",
    "ai/isolated/ask-for-use-card.lua": "lua/ai/isolated/ask-for-use-card.lua",
    "ai/isolated/ask-for-choice.lua": "lua/ai/isolated/ask-for-choice.lua",
    "ai/isolated/decision-core.lua": "lua/ai/isolated/decision-core.lua",
    "ai/isolated/retrial.lua": "lua/ai/isolated/retrial.lua",
    "ai/isolated/strategy-hooks.lua": "lua/ai/isolated/strategy-hooks.lua",
    "ai/isolated/event-intention.lua": "lua/ai/isolated/event-intention.lua",
    "ai/isolated/standard-ai.lua": "lua/ai/isolated/standard-ai.lua",
