...
The home UI uses a dark navy, ice-glass interface with restrained gold accents and cyan interactive states. Card Overview shares this visual language.

## 2. Color system

Home UI colors are defined in [`HomeTheme.qml`](qml/home/HomeTheme.qml). New card-browser surfaces use semantic `card*` tokens for page chrome, panels, text, filters, selection, badges, focus, and suit colors. Components must not contain raw color literals.
