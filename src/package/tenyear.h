...
class JieshiCard : public SkillCard
{
    Q_OBJECT
public:
    Q_INVOKABLE JieshiCard();
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class BizuCard : public SkillCard
{
    Q_OBJECT
public:
    Q_INVOKABLE BizuCard();
    void onUse(Room *room, CardUseStruct &use) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &tos) const;
};

class JilieCard : public SkillCard
{
    Q_OBJECT
public:
    Q_INVOKABLE JilieCard();
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class ShugangCard : public SkillCard
{
    Q_OBJECT
public:
    Q_INVOKABLE ShugangCard();
    void onUse(Room *room, CardUseStruct &use) const;
};

class DianlunCard : public SkillCard
{
    Q_OBJECT
public:
    Q_INVOKABLE DianlunCard();
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class ThJiweiCard : public SkillCard
{
    Q_OBJECT
public:
    Q_INVOKABLE ThJiweiCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void onUse(Room *room, CardUseStruct &use) const;
};

class QiaoduiCard : public SkillCard
{
    Q_OBJECT
public:
    Q_INVOKABLE QiaoduiCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class JunheCard : public SkillCard
{
    Q_OBJECT
public:
    Q_INVOKABLE JunheCard();
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class QuxianCard : public SkillCard
{
    Q_OBJECT
public:
    Q_INVOKABLE QuxianCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class ZouyiCard : public SkillCard
{
    Q_OBJECT
public:
    Q_INVOKABLE ZouyiCard();
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class ZhanyanCard : public SkillCard
{
    Q_OBJECT
public:
    Q_INVOKABLE ZhanyanCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class FuhuiCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE FuhuiCard();
    bool targetFixed() const;
    bool targetsFeasible(const QList<const Player *> &targets, const Player *Self) const;
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    const Card *validate(CardUseStruct &card_use) const;
...
class ZongtaoCard : public SkillCard
{
    Q_OBJECT
public:
    Q_INVOKABLE ZongtaoCard();
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class ChouxiCard : public SkillCard
{
    Q_OBJECT
public:
    Q_INVOKABLE ChouxiCard();
    void onUse(Room *room, CardUseStruct &use) const;
};

class JichaoCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE JichaoCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    bool targetsFeasible(const QList<const Player *> &targets, const Player *Self) const;
    void onUse(Room *room, CardUseStruct &use) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
...
class ShurenCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE ShurenCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class ShouhuCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE ShouhuCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void onUse(Room *room, CardUseStruct &use) const;
};

class ZijueCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE ZijueCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class JianliCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE JianliCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class HangzhuCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE HangzhuCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class ZhenyuCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE ZhenyuCard();
    bool targetFixed() const;
    bool targetsFeasible(const QList<const Player *> &targets, const Player *Self) const;
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    const Card *validate(CardUseStruct &card_use) const;
...
class JieluCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE JieluCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class DuluCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE DuluCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class YinmouCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE YinmouCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class HongceCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE HongceCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class XixingCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE XixingCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class LingshuCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE LingshuCard();
    bool targetFixed() const;
    bool targetsFeasible(const QList<const Player *> &targets, const Player *Self) const;
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    const Card *validate(CardUseStruct &card_use) const;
...
class YuzhengCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE YuzhengCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class HuozhongCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE HuozhongCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};
...
class JuxiCard : public SkillCard
{
    Q_OBJECT
public:
    Q_INVOKABLE JuxiCard();
    void onUse(Room *room, CardUseStruct &use) const;
};

class JuanjiCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE JuanjiCard();
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class ZhouxiCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE ZhouxiCard();
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class ShijinCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE ShijinCard();
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class FenhuiCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE FenhuiCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class MinzeCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE MinzeCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class ZixiCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE ZixiCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class LiangxiuCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE LiangxiuCard();
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class ZhengpiCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE ZhengpiCard();
    bool targetFixed() const;
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void onUse(Room *room, CardUseStruct &use) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
...
class CMFengyingCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE CMFengyingCard();
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class KuizhenCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE KuizhenCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class LiexiangCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE LiexiangCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class RengouCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE RengouCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void onUse(Room *room, CardUseStruct &use) const;
};

class BinjiCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE BinjiCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void onUse(Room *room, CardUseStruct &use) const;
};

class ZangmaoCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE ZangmaoCard();
    bool targetFixed() const;
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class XiangchenCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE XiangchenCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class YinzhiCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE YinzhiCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class ThSpShefuCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE ThSpShefuCard();
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &) const;
};

class RenshanCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE RenshanCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void onUse(Room *room, CardUseStruct &use) const;
};

class YizhiCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE YizhiCard();
    const Card *validate(CardUseStruct &card_use) const;
};

class PoyinCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE PoyinCard();
    void onUse(Room *room, CardUseStruct &use) const;
};

class MoguiCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE MoguiCard();
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};

class RenchengCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE RenchengCard();
    bool targetFixed() const;
    bool targetFilter(const QList<const Player *> &targets, const Player *to_select, const Player *Self) const;
    void use(Room *room, ServerPlayer *source, QList<ServerPlayer *> &targets) const;
};
