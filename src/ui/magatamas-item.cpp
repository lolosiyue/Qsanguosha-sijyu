...
{
    int xStep = 0, yStep = m_iconSize.height();
    ...
    for (int i = 0; i < 6; i++) {
        _icons[i] = G_ROOM_SKIN.getPixmap(QString(QSanRoomSkin::S_SKIN_KEY_MAGATAMAS).arg(i), QString(), true)
