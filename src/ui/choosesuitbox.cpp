...
SuitOptionButton::SuitOptionButton(QGraphicsObject *parent, const QString &suit, int width)
...
{
    int width = buttonWidth * suitNumber + outerBlankWidth * 2 + interval * (suitNumber - 1);
