    ...
    m_vScrollBar(NULL), m_oldScrollValue(0)
{
    ...
    QSanButton *closeButton = new QSanButton("card_container", "close", this);
    closeButton->setPos(387, 5);
    connect(closeButton, SIGNAL(clicked()), this, SLOT(close()));

    QGraphicsPixmapItem *kingdomColorMaskIcon = NULL;
    PlayerCardContainer::_paintPixmap(kingdomColorMaskIcon, QRect(11, 6, 87, 21),
    ...
    PlayerCardContainer::_paintPixmap(kingdomIcon, QRect(9, 2, 28, 25),
        G_ROOM_SKIN.getPixmap(QSanRoomSkin::S_SKIN_KEY_KINGDOM_ICON, kingdom), this);
    ...
    getAvatarNameFont().paintText(avatarNameItem, QRect(34, -8, 60, 40),
