...
void RecAnalysis::setDesignation()
{
    ...
    addDesignation(tr("Soy"), NoOption, rec_data / 2, true, "", false, true);
    ...
    addDesignation(tr("Rapid Victory"), NoOption, rec_data / 2, true, "", true, false, true);

    addDesignation(tr("Burning Soul"), MostDamage | MostDamaged);
    addDesignation(tr("Regretful Lose"), MostDamage | ZeroKill, M_ALL_PLAYER, true, "", false, false, false, true);
    ...
    addDesignation(tr("Unrealized Aspiration"), MostKill | MostDamage, M_ALL_PLAYER, true, "", false, false, false, true);
    ...
    addDesignation(tr("Master Tank"), MostDamaged, findPlayerOfDamaged(10), true, "", true, false, true);
    addDesignation(tr("War Spirit"), MostDamaged, findPlayerOfDamaged(10), true, "", true, false, false, true);
