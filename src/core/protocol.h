...
namespace QSanProtocol {
    ...
    enum StateEditorCheat
    {
        ...
        S_CHEAT_DrawCards,
        S_CHEAT_ThrowAllEquips,
        S_CHEAT_ThrowAllHandCards,
        S_CHEAT_ThrowAllHandCardsAndEquips,
        S_CHEAT_ThrowAllCards,
        S_CHEAT_ThrowCards,
        S_CHEAT_ThrowCardsWithoutEquips,
        S_CHEAT_SetChained,
        S_CHEAT_TurnOver,
        S_CHEAT_UseAnaleptic
    };
    ...
    enum CommandType
    {
        ...
        S_COMMAND_SKILL_DESCRIPTION_SWAP,
        ...
        S_COMMAND_ADD_PLAYER_DYNAMIC,
        S_COMMAND_TRIGGER_ORDER,
        S_COMMAND_SHOW_VIRTUAL_CARD,
        S_COMMAND_ANYTIME_SKILL,
        S_COMMAND_ANYTIME_SKILL_DONE,
        ...
        S_COMMAND_SKILL_TRANSFERFIELDCARDS,
