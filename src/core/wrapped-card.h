...
public:
    ...
    void setMark(const QString &mark, int value) const;
    ...
    inline void onUse(Room *room, CardUseStruct &cardUse) const
    {
        //Q_ASSERT(m_card != nullptr);
    ...
    inline void onEffect(CardEffectStruct &effect) const
    {
        //Q_ASSERT(m_card != nullptr);
