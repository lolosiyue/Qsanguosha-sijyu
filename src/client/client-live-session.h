...
struct ClientLiveSessionOptions
{
    ...
    // Identity generated by the owning product Engine and sent on signup.
    // Keeping this injectable leaves the transport session usable in bridges
    // and protocol fixtures that do not construct an Engine.
    QJsonObject localRulesBundle;
};
