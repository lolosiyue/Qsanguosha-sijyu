...
return {
	...
	["sidi"] = "司敌",
	[":sidi"] = "当你使用或其他角色在你的回合内使用【闪】时，你可以将牌堆顶的一张牌置于武将牌上。一名其他角色的出牌阶段开始时，你可以将一张“司敌牌”置入弃牌堆，然后该角色本回合使用【杀】的次数上限-1。",
	["sidi_remove"] = "你可以将一张“司敌牌”置入弃牌堆，令当前回合角色本回合使用【杀】的次数上限-1",
	["~sidi"] = "选择一张“司敌牌”→点击确定",
	
	["ol_caozhen"] = "曹真[OL]",
	["&ol_caozhen"] = "曹真",
	["illustrator:ol_caozhen"] = "Thinking",
	["ol_sidi"] = "司敌",
	[":ol_sidi"] = "其他角色出牌阶段开始时，你可以弃置一张非基本牌（须与你装备区里的牌颜色相同），然后该角色本回合不能使用和打出与此牌颜色相同的牌。此阶段结束时，若其于此阶段内没有使用【杀】，视为你对其使用一张【杀】。",
	["@ol_sidi-discard"] = "你可以弃置一张牌对 %src 发动“司敌”",
	...
	["faen"] = "法恩",
	[":faen"] = "当一名角色的武将牌翻面或横置时，你可以令其摸一张牌。",
	
	["ol_chenqun"] = "陈群[OL]",
	["&ol_chenqun"] = "陈群",
	["illustrator:ol_chenqun"] = "DH",
	["pindi"] = "品第",
	[":pindi"] = "出牌阶段，你可以弃置一张牌并选择一名其他角色（不能弃置相同类型牌且不能指定相同的角色），然后令其执行一项：摸X张牌；弃置X张牌（X为本回合此技能发动次数）。若其已受伤，你将武将牌横置。",
	["pindi:draw"] = "令其摸牌",
	["pindi:discard"] = "令其弃牌",
	["ol_faen"] = "法恩",
	[":ol_faen"] = "当一名角色的武将牌翻至正面向上或横置后，你可以令其摸一张牌。",
	...
	["bingyi"] = "秉壹",
	[":bingyi"] = "结束阶段，若你有手牌，你可以展示所有手牌：若均为同一颜色，你可以令至多X名角色各摸一张牌。（X为你的手牌数）",
	["@bingyi-card"] = "你可以展示所有手牌发动“秉壹”",
	["~bingyi"] = "若手牌均为同一颜色，选择至多X名角色→点击“确定”；否则直接点击“确定”",
	...
	["shenduan"] = "慎断",
	[":shenduan"] = "当你的黑色基本牌因弃置而置入弃牌堆时，你可以将之当【兵粮寸断】使用（无距离限制）。",
	["@shenduan-use"] = "你可以发动“慎断”将其中一张牌当【兵粮寸断】使用（无距离限制）",
	["~shenduan"] = "选择一张黑色基本牌→选择【兵粮寸断】的目标角色→点击确定",
	["yonglve"] = "勇略",
	[":yonglve"] = "当你攻击范围内的一名角色的判定阶段开始时，你可以弃置其判定区的一张牌：若如此做，视为对该角色使用一张【杀】（无距离限制）：若此【杀】未造成伤害，此【杀】结算后你摸一张牌。",
	...
	["jianying"] = "渐营",
	[":jianying"] = "当你于出牌阶段内使用一张牌时，若此牌与你本阶段使用的上一张牌花色或点数相同，你可以摸一张牌。",
	["shibei"] = "矢北",
    [":shibei"] = "锁定技，当你于一名角色的回合内受到伤害后，若为你本回合第一次受到伤害，你回复1点体力，否则你失去1点体力。",
	...
	["zenhui"] = "谮毁",
    [":zenhui"] = "出牌阶段限一次，当你于出牌阶段内使用【杀】或黑色非延时类锦囊牌指定唯一目标时，你可以令为此牌合法目标的另一名其他角色选择一项：交给你一张牌并成为此牌的使用者，或成为此牌的目标。",
	...
	["jiaojin"] = "骄矜",
	[":jiaojin"] = "当你受到男性角色的伤害时，你可以弃置一张装备牌：若如此做，此伤害-1。",
	...
	["ol_wuyi"] = "吴懿[OL]",
	["&ol_wuyi"] = "吴懿",
	["illustrator:ol_wuyi"] = "蚂蚁君",
	["olbenxi"] = "奔袭",
	[":olbenxi"] = "锁定技，当你于回合内使用牌时，本回合你与其他角色的距离-1；你的回合内，若你与所有其他角色的距离均为1，你使用仅指定一个目标的【杀】或非延时类锦囊牌时"..
					"依次选择至多两项：1.此牌目标+1；2.此牌无视防具；3.此牌不能被抵消；4.此牌造成伤害后，你摸一张牌。",
	["olbenxi:extra"] = "此牌目标+1",
	["olbenxi:ignore"] = "此牌无视防具",
	["olbenxi:noresponse"] = "此牌不能被抵消",
	["olbenxi:draw"] = "此牌造成伤害后，你摸一张牌。",
	["@olbenxi-extra"] = "请选择【%src】的额外目标",
	["~olbenxi"] = "选择【借刀杀人】和【杀】的额外目标→点“确定”",
	...
	["qiangzhi"] = "强识",
	[":qiangzhi"] = "出牌阶段开始时，你可以展示一名其他角色的一张手牌：若如此做，当你于此阶段内使用与此牌类别相同的牌时，你可以摸一张牌。",
	["qiangzhi-invoke"] = "你可以发动“强识”<br/> <b>操作提示</b>: 选择一名有手牌的其他角色→点击确定<br/>",
	["xiantu"] = "献图",
	[":xiantu"] = "一名其他角色的出牌阶段开始时，你可以摸两张牌：若如此做，你交给其两张牌；且本阶段结束时，若该角色未于本阶段杀死过一名角色，你失去1点体力。",
	["@xiantu-give"] = "请交给 %dest %arg 张牌",
	["#Xiantu"] = "%from 未于本阶段杀死过角色，%to 的“%arg”效果触发",
	...
	["zhongyong"] = "忠勇",
	[":zhongyong"] = "当你于出牌阶段内使用【杀】被【闪】抵消后，你可以令除目标角色外的一名角色获得弃牌堆中的此次使用的【闪】：若该角色不为你，你可以对同一目标角色再使用一张【杀】（无距离限制且不能选择额外目标）。",
	["zhongyong-invoke"] = "你可以发动“忠勇”<br/> <b>操作提示</b>: 选择除 %src 外的一名角色→点击确定<br/>",
	["zhongyong-slash"] = "你可以发动“忠勇”再对 %src 使用一张【杀】",
	
	["ol_zhoucang"] = "周仓[OL]",
	["&ol_zhoucang"] = "周仓",
	["illustrator:ol_zhoucang"] = "Sky",
	["ol_zhongyong"] = "忠勇",
	[":ol_zhongyong"] = "当你使用的【杀】结算完后，你可以将此【杀】或目标角色使用的【闪】交给除目标角色外的一名其他角色，若其中有红色牌，其可以对你攻击范围内的角色使用一张【杀】。",
	["ol_zhongyong:slash"] = "令其获得【杀】",
	["ol_zhongyong:jink"] = "令其获得【闪】",
	["@ol_zhongyong-invoke"] = "你可以发动“忠勇”",
	["@ol_zhongyong-slash"] = "你可以使用一张【杀】",
