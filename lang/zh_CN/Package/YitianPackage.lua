...
return {
	...
	[":yitian_sword"] = "装备牌/武器\
		<b>攻击范围</b>：２\
		<b>武器技能</b>：当你于回合外受到伤害结算后，你可以使用一张【杀】；当你失去装备区里的【倚天剑】时，你可以对一名其他角色造成1点伤害。",
	["@YitianSword-lost"] = "【倚天剑】：你可以选择一名其他角色，对其造成1点伤害。",
	["yitian-lost"] = "倚天剑",
	["@YitianSword-slash"] = "【倚天剑】：你在回合外受到了伤害，可以使用一张【杀】",

	-- 神曹操内测[三版]
	["#yt_shencaocao"] = "超世之英杰",
	["yt_shencaocao"] = "魏武帝",
	["weiwudi_guixin"] = "归心",
	[":weiwudi_guixin"] = "结束阶段，你可以选择一项：\
	  1. 改变一名其他角色的势力；\
	...
	["&yt_caochong"] = "曹冲",
	["ytchengxiang"] = "称象",
	[":ytchengxiang"] = "当你受到一次伤害后，你可以弃置X张点数之和与造成伤害的牌的点数相等的牌并选择至多X名角色，这些角色：已受伤，回复1点体力；未受伤，摸两张牌。",
	["@ytchengxiang-card"] = "请弃置点数之和为 %arg 的卡牌以发动“称象”技能",
	["~ytchengxiang"] = "选择若干张牌→选择若干名角色→点击确定",
	["conghui"] = "聪慧",
        [":conghui"] = "锁定技，你跳过弃牌阶段。",
	["zaoyao"] = "早夭",
        [":zaoyao"] = "锁定技，结束阶段，若你的手牌数大于13，你须弃置所有手牌并失去1点体力。",

	-- 张郃
	["#zhangjunyi"] = "计谋巧变",
	["zhangjunyi"] = "张儁乂",
	["jueji"] = "绝汲",
        [":jueji"] = "出牌阶段限一次，你可以与一名角色拼点：当你赢后，你获得对方的拼点牌。你可以重复此流程，直到你拼点没赢为止。",
	...
	["kegou"] = "克构",
        [":kegou"] = "觉醒技，准备阶段，若你是除主公外唯一的吴势力角色，你减少1点体力上限，获得技能“连营”。",
	...
	["xiahoujuan"] = "夏侯涓",
	["lianli"] = "连理",
	[":lianli"] = "准备阶段，你可以选择一名男性角色，你与其进入连理状态直到你的下回合开始：其可以替你使用或打出【闪】，你可以替其使用或打出【杀】。",
	["tongxin"] = "同心",
	[":tongxin"] = "当一名处于连理状态的角色受到1点伤害后，你可以令处于连理状态的角色各摸一张牌",
	["liqian"] = "离迁",
        [":liqian"] = "锁定技，若你处于连理状态，势力与连理对象的势力相同；当你处于未连理状态时，势力为魏",
	["lianli-slash"] = "连理（杀）",
	["lianlislash"] = "连理（杀）",
	["lianli-jink"] = "连理（闪）",
	...
	["jinxuandi"] = "晋宣帝",
	["wuling"] = "五灵",
	[":wuling"] = "准备阶段，你可选择一种五灵效果，该效果对场上所有角色生效\
	...
	["caizhaoji"] = "蔡昭姬",
	["guihan"] = "归汉",
        [":guihan"] = "出牌阶段限一次，你可以弃置两张花色相同的红色手牌并选择一名其他角色，与其交换位置。",
	["caizhaoji_hujia"] = "胡笳",
	[":caizhaoji_hujia"] = "结束阶段，你可以进行一次判定：若结果为红色，你获得此判定牌，若如此做，你可以重复此流程。若你在一个阶段内发动“胡笳”判定过至少三次，你将武将牌翻面。",
	...
	["luboyanf"] = "陆伯言(女)",
	["shenjun"] = "神君",
        [":shenjun"] = "锁定技，游戏开始时，你选择自己的性别；准备阶段，你须改变性别；当你受到异性角色造成的非雷属性伤害时，你防止之。",
	["shaoying"] = "烧营",
	[":shaoying"] = "当你对一名不处于连环状态的角色造成一次火焰伤害扣减体力前，你可选择一名其距离为1的一名角色，若如此做，此伤害结算完毕后，你进行一次判定：若结果为红色，你对其造成1点火属性伤害。",
	["#Shaoying"] = "%from 选择了“%arg”的目标 %to",
	["@shaoying"] = "你可选择一名角色发动“烧营”",
	["zonghuo"] = "纵火",
        [":zonghuo"] = "锁定技，你使用的【杀】视为【火杀】。",
	["#ShenjunChoose"] = "%from 选择了 %arg 作为初始性别",
	["#ShenjunProtect"] = "%to 的“%arg”触发，异性(%from)的非雷属性伤害无效",
	["#ShenjunFlip"] = "%from 的“%arg”触发，性别倒置",
	["#Zonghuo"] = "%from 的锁定技“%arg”触发，【杀】变为火属性",
	...
	["gongmou"] = "共谋",
	["@conspiracy"] = "共谋",
	[":gongmou"] = "结束阶段，你可以选择一名其他角色，若如此做，其于其下个摸牌阶段摸牌后，将X张手牌交给你（X为你手牌数与对方手牌数的较小值），然后你将X张手牌交给其。",
	...
	["jiangboyue"] = "姜伯约",
	["lexue"] = "乐学",
        [":lexue"] = "出牌阶段限一次，你可以令一名其他角色展示一张手牌：若此牌为基本牌或非延时类锦囊牌，你于当前回合内可以将与此牌同花色的牌当作该牌使用或打出；否则，你获得之。",
	["xunzhi"] = "殉志",
	...
	["jiawenhe"] = "贾文和",
	["dongcha"] = "洞察",
	[":dongcha"] = "准备阶段，你可以选择一名其他角色：其所有手牌于当前回合内对你可见。\
		<font color=\'purple\'>◆你以此法选择的角色的操作不公开，换言之，只有你知道洞察的目标。</font>",
	["dushi"] = "毒士",
        [":dushi"] = "锁定技，当你死亡时，杀死你的角色获得技能“崩坏”。",
	["@collapse"] = "崩坏",
	["@dongcha"] = "请选择“洞察”的目标",
	...
	["guzhielai"] = "古之恶来",
	["sizhan"] = "死战",
        [":sizhan"] = "锁定技，当你受到一次伤害时，你防止此伤害并获得等同于伤害点数的“死战”标记；结束阶段，你弃置所有的“死战”标记并失去等量的体力。",
	["shenli"] = "神力",
        [":shenli"] = "锁定技，你于出牌阶段内<font color='red'>第一次</font>使用【杀】造成伤害时，此伤害+X（X为当前死战标记数且最大为3）。",
	["#SizhanPrevent"] = "%from 的锁定技【%arg2】触发，防止了当前的 %arg 点伤害",
	["#SizhanLoseHP"] = "%from 的锁定技【%arg2】触发，流失了 %arg 点体力",
	["#ShenliBuff"] = "%from 的锁定技【神力】触发，【杀】的伤害增加了 %arg, 达到了 %arg2 点",
	["@struggle"] = "死战",
	...
	["toudu"] = "偷渡",
	[":toudu"] = "当你受到一次伤害后，若你的武将牌背面朝上，你可以弃置一张手牌，将你的武将牌翻面，然后视为使用一张【杀】。",
	...
	["xiliang"] = "惜粮",
	[":xiliang"] = "当其他角色于其弃牌阶段因弃置失去一张红色牌后，你可以选择一项：1.将之置于你的武将牌上，称为“米”；2.获得之。",
	["ytrice"] = "米",
	["xiliang:put"] = "收为“米”",
	["xiliang:obtain"] = "获得此牌",
	["ytyishe_ask"] = "义舍要牌",
	...
	["yitianjian"] = "倚天剑",
	["zhengfeng"] = "争锋",
        [":zhengfeng"] = "锁定技，若你的装备区没有武器牌，你的攻击范围为X（X为你的体力值）。",
	["ytzhenwei"] = "镇威",
	[":ytzhenwei"] = "当你使用的【杀】被【闪】抵消时，你可以获得处理区里的此【闪】。",
	["yitian"] = "倚天",
	[":yitian"] = "<b>联动技</b>，当你对曹操造成伤害时，你可以令该伤害-1。",
