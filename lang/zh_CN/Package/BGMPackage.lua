...
return {
	...
	["kuiwei"] = "溃围",
	[":kuiwei"] = "结束阶段，你可以摸X+2张牌：若如此做，将武将牌翻面，且你的下个摸牌阶段开始时，你弃置X张牌。（X为场上武器牌的数量）",
	["yanzheng"] = "严整",
	[":yanzheng"] = "若你的手牌数大于你的体力值，你可以将一张装备区的牌当【无懈可击】使用。",
	["#KuiweiDiscard"] = "%from 的“%arg2”触发，须弃置 %arg 张牌";
	...
	["manjuan"] = "漫卷",
	[":manjuan"] = "当你将获得一张手牌时，你将之置入弃牌堆。若你的回合内你发动“漫卷”，你可以获得弃牌堆中一张与此牌同点数的牌（不能发动“漫卷”）。",
	["zuixiang"] = "醉乡",
        [":zuixiang"] = "限定技，准备阶段，你可以将牌堆顶的三张牌置于你的武将牌上。此后每个准备阶段，你重复此流程，直到你的武将牌上出现同点数的“醉乡牌”，然后你获得所有“醉乡牌”（不能发动“漫卷”）。你不能使用或打出“醉乡牌”中存在的类别的牌，且这些类别的牌对你无效。",
	["dream"] = "醉乡",
	["$ZuixiangAnimate"] = "image=image/animate/zuixiang.png",
	["$ManjuanGot"] = "%from 即将获得 %card 并将此牌置入弃牌堆",
	["#ZuiXiang1"] = "%from 的“%arg2”触发， %to 的卡牌【%arg】对其无效",
	["#ZuiXiang2"] = "%from 的“%arg2”触发，【%arg】对其无效",
	...
	["jie"] = "嫉恶",
        [":jie"] = "锁定技，你使用红色【杀】对目标角色造成伤害时，此伤害+1。",
	["dahe"] = "大喝",
        [":dahe"] = "出牌阶段限一次，你可以与一名其他角色拼点：若你赢，你可以将该角色的拼点牌交给一名体力值不大于你的角色，本回合该角色使用的非红桃【闪】无效；若你没赢，你展示所有手牌，然后弃置一张手牌。",
	["@dahe-give"] = "你可以将拼点牌交给一名体力值不大于你的角色",
	["#Jie"] = "%from 的“<font color=\"yellow\"><b>嫉恶</b></font>”触发，伤害从 %arg 点增加至 %arg2 点",
	["#DaheEffect"] = "%from 的“%arg2”触发，%to 使用的 %arg 【<font color=\"yellow\"><b>闪</b></font>】无效",
	...
	["tanhu"] = "探虎",
        [":tanhu"] = "出牌阶段限一次，你可以与一名其他角色拼点：若你赢，你无视与该角色的距离，你使用的非延时锦囊牌对该角色结算时不能被【无懈可击】响应，直到回合结束。",
	["mouduan"] = "谋断",
	...
	["shichou"] = "誓仇",
        [":shichou"] = "主公技，限定技，准备阶段，你可以选择一名其他蜀势力角色并交给其两张牌。当你受到伤害时，你将此伤害转移给该角色，此伤害结算后该角色摸X张牌，直到其第一次进入濒死状态时。（X为伤害点数）",
	["@shichou-give"] = "你可以发动“誓仇”",
	["~shichou"] = "选择两张牌→选择一名其他蜀势力角色→点击确定",
	["$ShichouAnimate"] = "image=image/animate/shichou.png",
	["#ShichouProtect"] = "%from 的“%arg”触发，将伤害转移给 %to ",
	...
	["YanxiaoCard"] = "言笑牌",
	["anxian"] = "安娴",
	[":anxian"] = "当你使用【杀】对目标角色造成伤害时，你可以防止此伤害：若如此做，该角色弃置一张手牌，然后你摸一张牌。当你成为【杀】的目标时，你可以弃置一张手牌：若如此做，此【杀】的使用者摸一张牌，此【杀】对你无效。",
	...
	["brocade"] = "锦",
	["junwei"] = "军威",
	[":junwei"] = "结束阶段，你可以将三张“锦”置入弃牌堆并选择一名角色：若如此做，该角色可以展示一张【闪】并将之交给由你选择的一名角色，否则该角色失去1点体力，你将其装备区的一张牌移出游戏：若如此做，该角色的回合结束后，将这张装备牌移回其装备区（代替原装备）。",
	...
	["fenyong"] = "愤勇",
	[":fenyong"] = "当你受到伤害后，你可以竖置体力牌。一名角色的结束阶段，若你的体力牌处于竖置状态，你横置之。当你受到伤害时，若你的体力牌处于竖置状态，防止此伤害。",
	["xuehen"] = "雪恨",
        [":xuehen"] = "锁定技，当你的体力牌横置时，你选择一项：1.弃置当前回合角色X张牌。 2.视为你使用一张无距离限制的【杀】。（X为你已损失的体力值）",
	["xuehen:discard"] = "弃置当前回合角色X张牌",
	["xuehen:slash"] = "视为使用一张【杀】",
	["#FenyongAvoid"] = "%from 的“%arg”触发，防止了本次伤害",
	...
	["langgu"] = "狼顾",
	[":langgu"] = "当你受到1点伤害后，你可以进行判定且你可以打出一张手牌代替此判定牌：若如此做，你观看伤害来源的所有手牌，然后你可以弃置其中至少一张与判定牌花色相同的牌。",
	...
	["fuluan"] = "扶乱",
    [":fuluan"] = "出牌阶段限一次，若你未于出牌阶段使用过【杀】，你可以弃置三张相同花色的牌并选择攻击范围内的一名角色：若如此做，该角色将武将牌翻面，你不能使用【杀】直到回合结束。",
	["shude"] = "淑德",
	[":shude"] = "结束阶段，你可以将手牌补至体力上限。",
	...
	["huangen"] = "皇恩",
	[":huangen"] = "当至少两名角色成为非延时锦囊牌的目标后，你可以令其中至多X名角色各摸一张牌，然后此牌对这些角色无效。（X为你的体力值）",
	["hantong"] = "汉统",
	...
	["tuqi"] = "突骑",
        [":tuqi"] = "锁定技，准备阶段，若你的武将牌上有“扈”，你将所有“扈”置入弃牌堆：若X小于或等于2，你摸一张牌。本回合你与其他角色的距离-X。（X为以此法置入弃牌堆的“扈”的数量）",
	["retinue"] = "扈",
	["@diyyicong"] = "你可以发动“義從”",
