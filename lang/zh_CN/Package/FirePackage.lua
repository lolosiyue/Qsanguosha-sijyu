...
return {
	...
	["quhu"] = "驱虎",
        [":quhu"] = "出牌阶段限一次，你可以与一名体力值大于你的角色拼点：若你赢，该角色对其攻击范围内的一名由你选择的角色造成1点伤害；若你没赢，该角色对你造成1点伤害。",
	["@quhu-damage"] = "请选择 %src 攻击范围内的一名角色",
	["jieming"] = "节命",
	[":jieming"] = "当你受到1点伤害后，你可以令一名角色将手牌补至X张。（X为该角色体力上限且至多为5）",
	...
	["qiangxi"] = "强袭",
        [":qiangxi"] = "出牌阶段限一次，你可以失去1点体力或弃置一张武器牌，并选择攻击范围内的一名角色：若如此做，你对该角色造成1点伤害。",
	...
	["niepan"] = "涅槃",
        [":niepan"] = "限定技，当你处于濒死状态时，你可以弃置你区域内的牌，将武将牌恢复至初始状态，然后摸三张牌并回复至3点体力。",
	...
	["tianyi"] = "天义",
        [":tianyi"] = "出牌阶段限一次，你可以与一名其他角色拼点：若你赢，本回合，你可以额外使用一张【杀】，你使用【杀】可以额外选择一名目标且无距离限制；若你没赢，你不能使用【杀】，直到回合结束。",
	...
	["shuangxiong"] = "双雄",
	[":shuangxiong"] = "摸牌阶段开始时，你可以放弃摸牌并进行判定，获得判定牌。本回合，你可以将与本回合任一次“双雄”判定牌颜色不同的手牌当【决斗】使用。",
