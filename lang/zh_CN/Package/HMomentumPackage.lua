...
return {
	...
	["hengjiang"] = "横江",
	[":hengjiang"] = "当你受到1点伤害后，你可以令当前回合角色本回合手牌上限-1，然后其回合结束时，若你于此回合发动过“横江”，且其未于弃牌阶段内弃置牌，你摸一张牌。",
	...
	["guixiu"] = "闺秀",
        [":guixiu"] = "当你失去“闺秀”后，你可以回复1点体力。限定技，准备阶段开始时或出牌阶段，你可以摸两张牌。",
	...
	["duanxie"] = "断绁",
        [":duanxie"] = "出牌阶段限一次，你可以选择一名不处于连环状态的其他角色：若如此做，你横置该角色的武将牌，然后横置你的武将牌。",
	["fenming"] = "奋命",
	[":fenming"] = "结束阶段，若你处于连环状态，你可以弃置所有处于连环状态的角色的各一张牌。",
	...
	["chuanxin"] = "穿心",
	[":chuanxin"] = "当你使用【杀】或【决斗】对目标角色造成伤害时，你可以防止此伤害，令其选择一项：1.若其有多于一个武将技能，其选择失去一项武将技能（对每名角色限一次）；2.弃置装备区的所有牌（至少一张）：若如此做，其失去1点体力。",
	["chuanxin_lose"] = "穿心失去技能",
	["chuanxin:throw"] = "弃置装备区的所有牌，失去1点体力",
	["chuanxin:detach"] = "失去一项武将技能",
	["fengshi"] = "锋矢",
	[":fengshi"] = "当一名角色成为【杀】的目标后，若你与此【杀】使用者均与该角色相邻，你可以令该角色弃置一张装备区的牌。",
