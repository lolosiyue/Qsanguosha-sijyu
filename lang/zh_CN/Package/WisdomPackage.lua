...
local t = {
	...
	["&wis_xuyou"] = "许攸",
	["juao"] = "倨傲",
        [":juao"] = "出牌阶段限一次，你可以将两张手牌背面向上移出游戏并选择一名角色，该角色的下个回合开始阶段开始时，须获得你移出游戏的两张牌并跳过摸牌阶段。",
	["hautain"] = "倨傲牌",
	["#JuaoObtain"] = "%from 受到了“%arg”的影响",
	["tanlan"] = "贪婪",
	[":tanlan"] = "当你受到其他角色造成的一次伤害后，可与伤害来源拼点：若你赢，你获得双方的拼点牌。",
	["shicai"] = "恃才",
        [":shicai"] = "锁定技，若你向其他角色发起拼点且你拼点赢时，或其他角色向你发起拼点且拼点没赢时，你摸一张牌",

	["#wis_jiangwei"] = "天水麒麟",
	["wis_jiangwei"] = "智姜维",
	["&wis_jiangwei"] = "姜维",
	["yicai"] = "异才",
	[":yicai"] = "当你使用一张非延时类锦囊时，你可以使用一张【杀】。",
	["beifa"] = "北伐",
        [":beifa"] = "锁定技，当你失去最后的手牌时，视为你对一名其他角色使用了一张【杀】，若不能如此做，则视为你对自己使用了一张【杀】。",

	["#wis_jiangwan"] = "武侯后继",
	["wis_jiangwan"] = "智蒋琬",
	["&wis_jiangwan"] = "蒋琬",
	["houyuan"] = "后援",
        [":houyuan"] = "出牌阶段限一次，你可以弃置两张手牌并令一名其他角色摸两张牌。",
	["chouliang"] = "筹粮",
	[":chouliang"] = "回合结束阶段，若你手牌少于三张，你可以从牌堆顶亮出4-X张牌（X为你的手牌数），你获得其中的基本牌，将其余的牌置入弃牌堆。",

	["#wis_sunce"] = "江东的小霸王",
	["wis_sunce"] = "智孙策",
	["&wis_sunce"] = "孙策",
	["bawang"] = "霸王",
	[":bawang"] = "当你使用的【杀】被【闪】抵消时，你可以与目标角色拼点：若你赢，可以视为你对至多两名角色各使用了一张【杀】（此杀不计入次数）。",
	["@bawang"] = "你可以发动技能“霸王”",
	["~bawang"] = "选择 1-2 名角色→点击确定",
	["weidai"] = "危殆",
        [":weidai"] = "主公技，当你需要使用一张【酒】时，你可以令其他吴势力角色打出一张黑桃2~9的手牌，则你将之当做【酒】使用。",
...
--  ["analeptic:ignore"] = "我是打酱油的~",
	...
	["&wis_zhangzhao"] = "张昭",
	["longluo"] = "笼络",
	[":longluo"] = "回合结束阶段，你可以令一名其他角色摸你于此回合弃牌阶段弃置的牌等量的牌。",
	["fuzuo"] = "辅佐",
	[":fuzuo"] = "当其他角色拼点时，你可以弃置一张点数小于8的手牌，让其中一名角色的拼点牌的点数加上这张牌点数的二分之一（向下取整）",
	...
	["#Wenjiu2"] = "%from 的【温酒】触发，伤害从 %arg 点上升至 %arg2 点",
	...
	["yuwen"] = "狱刎",
        [":yuwen"] = "锁定技，当你死亡时，伤害来源为自己。",
	["@shipo"] = "你可以发动“识破”弃置两张牌获得%src判定区内所有牌",

	["#wis_shuijing"] = "水镜先生",
	["wis_shuijing"] = "智司马徽",
	["&wis_shuijing"] = "司马徽",
	["shouye"] = "授业",
	[":shouye"] = "出牌阶段，你可以弃置一张红色手牌，令至多两名其他角色各摸一张牌。“解惑”触发后，每阶段限一次。",
	["@shouye"] = "授业",
	["jiehuo"] = "解惑",
        [":jiehuo"] = "觉醒技，当你发动“授业”不少于7人次时，须减1点体力上限，并获得技能“师恩”（其他角色使用非延时锦囊时，可以让你摸一张牌）。",
	["#JiehuoWake"] = "%from 的觉醒技“%arg”已触发，以后你每阶段只能发动一次“%arg2”",
	["shien"] = "师恩",
