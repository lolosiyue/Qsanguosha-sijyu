...
return {
	...
	["ziliang"] = "资粮",
	[":ziliang"] = "当一名角色受到伤害后，你可以将一张“田”交给该角色。",
	...
	["huyuan"] = "护援",
	[":huyuan"] = "结束阶段，你可以将一张装备牌置于一名角色装备区内，然后你弃置该角色距离1的一名角色区域内的一张牌。",
	...
	["shengxi"] = "生息",
	[":shengxi"] = "当你的出牌阶段结束时，若你于此阶段未造成伤害，你可以摸两张牌。",
	["shoucheng"] = "守成",
	[":shoucheng"] = "当一名角色于其回合外失去最后的手牌后，你可以令该角色选择是否摸一张牌。",
	...
	["shangyi"] = "尚义",
        [":shangyi"] = "出牌阶段限一次，你可以令一名其他角色观看你的手牌，然后你选择一项：1.观看其手牌，然后你可以弃置其中一张黑色牌。2.观看其身份牌。",
	["shangyi:handcards"] = "手牌",
	["shangyi:role"] = "身份牌",
	["shangyi:remainedgenerals"] = "备选武将",
	["shangyi:generals"] = "暗将",
	["niaoxiang"] = "鸟翔",
	[":niaoxiang"] = "当一名角色成为【杀】的目标后，若你与此【杀】使用者均与该角色相邻，你可以令该角色须使用两张【闪】抵消此【杀】。",
	...
	["yicheng"] = "疑城",
	[":yicheng"] = "当一名角色成为【杀】的目标后，你可以令该角色摸一张牌，然后弃置一张牌。",
	...
	["qianhuan"] = "千幻",
	[":qianhuan"] = "当一名角色受到伤害后，该角色可以将牌堆顶的一张牌置于你的武将牌上：若此牌与一张其他“千幻牌”花色相同，将之置入弃牌堆。当一名角色成为基本牌或锦囊牌的唯一目标时，若该角色同意，你可以将一张“千幻牌”置入弃牌堆：若如此做，取消该目标。",
