...
return {
	...
	["qice"] = "奇策",
    [":qice"] = "出牌阶段限一次，你可以将所有手牌（至少一张）当任意一张非延时类锦囊牌使用。",
	["zhiyu"] = "智愚",
	[":zhiyu"] = "当你受到伤害后，你可以摸一张牌：若如此做，你展示所有手牌。若你的手牌均为同一颜色，伤害来源弃置一张手牌。",
	...
	["zhenlie"] = "贞烈",
	[":zhenlie"] = "当你成为其他角色的【杀】或非延时锦囊牌的目标后，你可以失去1点体力：若如此做，你弃置该角色的一张牌，此牌对你无效。",
	["miji"] = "秘计",
	...
	["qianxi"] = "潜袭",
	[":qianxi"] = "准备阶段，你可以进行判定：若如此做，你令一名距离1的角色不能使用或打出与判定牌颜色相同的手牌，直到回合结束。",
	...
	["fuli"] = "伏枥",
    [":fuli"] = "限定技，当你处于濒死状态时，你可以将回复至X点体力，然后将武将牌翻面。（X为现存势力数）",
	...
	["fuhun"] = "父魂",
	[":fuhun"] = "你可以将两张手牌当普通【杀】使用或打出。当你于出牌阶段内以此法使用【杀】造成伤害后，你拥有“武圣”、“咆哮”，直到回合结束。",
	...
	["lihuo"] = "疠火",
	[":lihuo"] = "你可以将一张普通【杀】当【火杀】使用。你以此法使用【杀】结算后，若此【杀】造成了伤害，你失去1点体力。你使用【火杀】可以额外选择一名目标。",
	["chunlao"] = "醇醪",
	[":chunlao"] = "结束阶段，若你的武将牌上没有“醇”，你可以将至少一张【杀】置于武将牌上，称为“醇”。当一名角色处于濒死状态时，你可以将一张“醇”置入弃牌堆，视为该角色使用一张【酒】。",
	["wine"] = "醇",
	["@chunlao"] = "你可以发动“醇醪”",
	...
	["anxu"] = "安恤",
    [":anxu"] = "出牌阶段限一次，你可以选择手牌数不等的两名其他角色：若如此做，手牌较少的角色正面朝上获得另一名角色的一张手牌。若此牌不为黑桃，你摸一张牌。",
	["zhuiyi"] = "追忆",
	...
	["gongqi"] = "弓骑",
    [":gongqi"] = "出牌阶段限一次，你可以弃置一张牌：若如此做，本回合你的攻击范围无限；若此牌为装备牌，你可以弃置一名其他角色的一张牌。",
	...
	["olzishou:olzishou"] = "你是否发动“自守”多摸%src张牌？",
	["#OLzishouPrevent"] = "%from 的“%arg”触发，防止了对 %to 的 %arg2 点伤害",
	...
	["shiyong"] = "恃勇",
    [":shiyong"] = "锁定技，当你受到一次红色【杀】或【酒】【杀】的伤害后，你失去1点体力上限。",
}
