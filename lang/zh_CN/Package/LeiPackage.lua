...
return {
	...
	["zuilun"] = "罪论",
	[":zuilun"] = "结束阶段，你可以观看牌堆顶的三张牌，你每满足以下一项便保留一张，然后以任意顺序放回其余的牌：1.你于此回合内造成过伤害；2.你于此回合内未弃置过牌；3.手牌数为全场最少。若均不满足，你与一名其他角色失去1点体力。",
	["#ZuilunNum"] = "%from 共满足 %arg 项，可以获得 %arg 张牌",
	["zuilun:zuilun_get"] = "你是否发动“罪论”获得%src张牌？",
	...
	["jueyan:4"] = "废除宝物栏",
	["poshi"] = "破势",
	[":poshi"] = "觉醒技，准备阶段，若你的装备栏均被废除或体力值为1，你减1点体力上限，然后将手牌补至体力上限，失去技能“决堰”并获得技能“怀柔”。",
	["huairou"] = "怀柔",
	...
	["zhengu"] = "镇骨",
	[":zhengu"] = "结束阶段，你可以选择一名其他角色，你的回合结束时和该角色的下个回合结束时，其将手牌摸至或弃至与你手牌数相同（最多摸至五张）。",
	["@zhengu-invoke"] = "你可以发动“镇骨”",
	["#ZhenguEffect"] = "%from 的“%arg”效果触发",
	...
	["honor"] = "荣",
	["hongju"] = "鸿举",
	[":hongju"] = "觉醒技，准备阶段，若“荣”的数量不小于3且有角色死亡，你可以用任意张手牌替换等量的“荣”，然后减1点体力上限并获得技能“清侧”。",
	["@hongju"] = "你可以用任意张手牌替换等量的“荣”",
	["~hongju"] = "选择任意张手牌和等量的“荣”→点“确定”",
	["qingce"] = "清侧",
	[":qingce"] = "出牌阶段，你可以移去一张“荣”，然后弃置场上的一张牌。",
	
	["ol_guanqiujian"] = "毌丘俭[OL]",
	["&ol_guanqiujian"] = "毌丘俭",
	["illustrator:ol_guanqiujian"] = "凝聚永恒",
	["olzhengrong"] = "征荣",
	[":olzhengrong"] = "当你使用【杀】或伤害类锦囊牌指定目标后，你可以选择其中一个手牌数大于等于你的目标角色，将其一张牌置于你的武将牌上，称为“荣”。",
	--["olrong"] = "荣",
	["@olzhengrong-invoke"] = "你可以发动“征荣”",
	["olhongju"] = "鸿举",
	[":olhongju"] = "觉醒技，准备阶段，若“荣”的数量大于等于3，你可以用任意张手牌替换等量的“荣”，然后减1点体力上限并获得技能“清侧”。",
	...
	["illustrator:mobile_guanqiujian"] = "凝聚永恒",
	["mobilezhengrong"] = "征荣",
	...
	["mobilehongju"] = "鸿举",
	[":mobilehongju"] = "觉醒技，准备阶段，若“荣”的数量不小于3且有角色死亡，你摸等于“荣”数量的牌，以任意张手牌替换等量的“荣”，然后你减1点体力上限，获得技能“清侧”。",
	...
	["#LeiyongsiDrawNum"] = "%from 的“%arg”触发，改为摸 %arg2 张牌",
	["#LeiyongsiDraw"] = "%from 的“<font color=\"yellow\"><b>庸肆</b></font>”触发，本回合共造成 %arg 点伤害，将摸 %arg2 张牌",
	["#LeiyongsiMax"] = "%from 的“<font color=\"yellow\"><b>庸肆</b></font>”触发，本回合共造成 %arg 点伤害，本回合手牌上限等于 %arg2",
	["leiweidi"] = "伪帝",
