...
return {
	...
	["dengai"] = "邓艾",
	["tuntian"] = "屯田",
	[":tuntian"] = "你的回合外，当你失去一次牌后，你可以进行判定：若结果不为红桃，将判定牌置于武将牌上，称为“田”。你与其他角色的距离-X。（X为“田”的数量）",
	["#tuntian-dist"] = "屯田",
	["field"] = "田",
	["zaoxian"] = "凿险",
    [":zaoxian"] = "觉醒技，准备阶段，若你的“田”大于或等于三张，你失去1点体力上限，然后获得“急袭”。",
	["$ZaoxianAnimate"] = "image=image/animate/zaoxian.png",
	["jixi"] = "急袭",
	[":jixi"] = "你可以将一张“田”当【顺手牵羊】使用。",
	["@jixi-target"] = "请选择【顺手牵羊】的目标角色",
	["~jixi"] = "选择【顺手牵羊】的目标角色→点击确定",
	["#ZaoxianWake"] = "%from 的“%arg3”为 %arg 张，触发“%arg2”觉醒",

	["#jiangwei"] = "龙的衣钵",
	["jiangwei"] = "姜维",
	["tiaoxin"] = "挑衅",
        [":tiaoxin"] = "出牌阶段限一次，你可以令攻击范围内包含你的一名角色对你使用一张【杀】，否则你弃置其一张牌。",
	["@tiaoxin-slash"] = "%src 对你发动“挑衅”，请对其使用一张【杀】",
	["zhiji"] = "志继",
        [":zhiji"] = "觉醒技，准备阶段，若你没有手牌，你失去1点体力上限，然后回复1点体力或摸两张牌，并获得“观星”。",
	["zhiji:draw"] = "摸两张牌",
	...
	["xiangle"] = "享乐",
        [":xiangle"] = "锁定技，当你成为【杀】的目标时，【杀】的使用者须弃置一张基本牌，否则此【杀】对你无效。",
	...
	["ruoyu"] = "若愚",
        [":ruoyu"] = "主公技，觉醒技，准备阶段，若你的体力值为场上最少（或之一），你增加1点体力上限，回复1点体力，然后获得“激将”。",
	...
	["sunce"] = "孙策",
	["jiang"] = "激昂",
	[":jiang"] = "当你指定或成为红色【杀】或【决斗】的目标后，你可以摸一张牌。",
	["hunzi"] = "魂姿",
        [":hunzi"] = "觉醒技，准备阶段，若你的体力值为1，你失去1点体力上限，然后获得“英姿”和“英魂”。",
	["$HunziAnimate"] = "image=image/animate/hunzi.png",
	["zhiba"] = "制霸",
	["zhiba_pindian"] = "制霸拼点",
        [":zhiba"] = "主公技，出牌阶段限一次，其他吴势力角色的出牌阶段，该角色可以与你拼点：若该角色没赢，你可以获得你与该角色的拼点牌。若你已发动“魂姿”，你可以拒绝此拼点。",
	...
	["#HunziWake"] = "%from 的体力值为 %arg，触发“%arg2”觉醒",
	...
	["beige"] = "悲歌",
	[":beige"] = "当一名角色受到一次【杀】的伤害后，你可以弃置一张牌令该角色进行判定：若结果为红桃，该角色回复1点体力；方块，该角色摸两张牌；黑桃，伤害来源将其武将牌翻面；梅花，伤害来源弃置两张牌。",
	["@beige"] = "你可以弃置一张牌发动“悲歌”",
	["duanchang"] = "断肠",
        [":duanchang"] = "锁定技，杀死你的角色失去所有武将技能。",
	["@duanchang"] = "断肠",
	["#DuanchangLoseSkills"] = "%from 的“%arg”触发， %to 失去所有武将技能",
	...
	["xinsheng"] = "新生",
	[":xinsheng"] = "当你受到1点伤害后，你可以获得一张“化身牌”。",
