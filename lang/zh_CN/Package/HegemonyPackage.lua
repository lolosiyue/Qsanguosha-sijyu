...
return {
	...
	["mingshi"] = "名士",
        [":mingshi"] = "锁定技，当你受到有来源的伤害时，若伤害来源装备区的牌数不大于X，此伤害-1。（X为你装备区的牌数且至多为2）",
	["lirang"] = "礼让",
	[":lirang"] = "当你的牌因弃置而置入弃牌堆时，你可以将其中至少一张牌任意分配给其他角色。",
	["@lirang-distribute"] = "你可以发动“礼让”将 %arg 张牌任意分配给其他角色",
	["#Mingshi"] = "%from 的“<font color=\"yellow\"><b>名士</b></font>”触发，伤害从 %arg 点减少至 %arg2 点",
	...
	["sijian"] = "死谏",
	[":sijian"] = "当你失去最后的手牌后，你可以弃置一名其他角色的一张牌。",
	["sijian-invoke"] = "你可以发动“死谏”<br/> <b>操作提示</b>: 选择一名有牌的其他角色→点击确定<br/>",
	["suishi"] = "随势",
	[":suishi"] = "当其他角色进入濒死状态时，伤害来源可以令你摸一张牌；当其他角色死亡时，伤害来源可以令你失去1点体力。",
