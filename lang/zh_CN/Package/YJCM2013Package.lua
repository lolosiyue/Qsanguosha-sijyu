...
return {
	...
	["chengxiang"] = "称象",
	[":chengxiang"] = "当你受到伤害后，你可以亮出牌堆顶的四张牌，然后获得其中至少一张点数之和小于或等于13的牌，并将其余的牌置入弃牌堆。",
	["renxin"] = "仁心",
	[":renxin"] = "当一名体力值为1的其他角色受到伤害时，你可以将武将牌翻面并弃置一张装备牌：若如此做，防止此伤害。",
	...
	["junxing"] = "峻刑",
    [":junxing"] = "出牌阶段限一次，你可以弃置任意数量的手牌并选择一名其他角色：若如此做，该角色须弃置一张与你弃置的牌类型均不同的手牌，否则将武将牌翻面并摸X张牌。（X为你弃置的牌的数量）",
	...
	["longyin"] = "龙吟",
	[":longyin"] = "当一名角色于出牌阶段内使用【杀】时，你可以弃置一张牌：若如此做，此【杀】不计入次数限制，若此【杀】为红色，你摸一张牌。",
	...
	["xiansi"] = "陷嗣",
	[":xiansi"] = "准备阶段，你可以将一至两名角色的各一张牌置于你的武将牌上，称为“逆”。其他角色可以将两张“逆”置入弃牌堆，视为对你使用一张【杀】（计入次数限制）。",
	...
	["duodao"] = "夺刀",
	[":duodao"] = "当你受到【杀】的伤害后，你可以弃置一张牌：若如此做，你获得伤害来源装备区的武器牌。",
	["@duodao-get"] = "你可以弃置一张牌发动“夺刀”",
	["anjian"] = "暗箭",
	[":anjian"] = "当你使用【杀】对目标角色造成伤害时，若你不在其攻击范围内，此伤害+1。",
	["#AnjianBuff"] = "%from 的“<font color=\"yellow\"><b>暗箭</b></font>”触发，伤害从 %arg 点增加至 %arg2 点",
	...
	["juece"] = "绝策",
	[":juece"] = "结束阶段，你可以对一名没有手牌的角色造成1点伤害。",
	...
	["fencheng"] = "焚城",
    [":fencheng"] = "限定技，出牌阶段，你可以令所有其他角色：弃置至少X张牌，否则受到你造成的2点火焰伤害。（X为上一名进行选择的角色以此法弃置的牌数+1）",
