...
return {
	...
	["jianxiong"] = "奸雄",
	[":jianxiong"] = "当你受到伤害后，你可以选择一项：获得对你造成伤害的牌，或摸一张牌。",
	["jianxiong:obtain"] = "获得对你造成伤害的牌",
	["jianxiong:draw"] = "摸一张牌",
	["hujia"] = "护驾",
        [":hujia"] = "主公技，当你需要使用或打出一张【闪】时，你可以令其他魏势力角色打出一张【闪】，视为你使用或打出之。",
	...
	["ganglie"] = "刚烈",
	[":ganglie"] = "当你受到1点伤害后，你可以进行判定：若结果为红色，你对伤害来源造成1点伤害；黑色，你弃置伤害来源一张牌。",
	["qingjian"] = "清俭",
	[":qingjian"] = "当你于摸牌阶段外获得手牌后，你可以将其中至少一张牌任意分配给其他角色。",
	...
	["yiji"] = "遗计",
	[":yiji"] = "当你受到1点伤害后，你可以摸两张牌，然后你可以分别在至多两名其他角色的武将牌旁扣置一至两张手牌：若如此做，这些角色的摸牌阶段开始时，其获得所有“遗计牌”。",
	...
	["#LuoyiBuff"] = "%from 的“<font color=\"yellow\"><b>裸衣</b></font>”效果触发，对 %to 的伤害从 %arg 点增加至 %arg2 点",

	["#zhenji"] = "薄幸的美人",
	["zhenji"] = "甄姬",
	["illustrator:zhenji"] = "Kayak",
	["designer:zhenji"] = "Kayak",
	["luoshen"] = "洛神",
	[":luoshen"] = "准备阶段，你可以进行判定：若结果为黑色，判定牌生效后你获得之，然后你可以再次发动“洛神”。",
	["qingguo"] = "倾国",
	...
	["wangxi"] = "忘隙",
	[":wangxi"] = "当你对其他角色造成1点伤害后，或你受到其他角色的1点伤害后，若该角色存活，你可以与其各摸一张牌。",
	...
	["rende"] = "仁德",
        [":rende"] = "出牌阶段，你可以将至少一张手牌交给一名本阶段未以此法获得过牌的其他角色。本阶段以此法交出的手牌首次达到两张时，你可以视为使用一张基本牌。",
        [":rende_p"] = "出牌阶段限一次，你可以将至少一张手牌任意分配给其他角色。当你于本阶段内以此法给出的手牌首次达到两张或更多后，你回复1点体力。",
        ["rende_basic"] = "仁德",
        ["@rende-basic"] = "你可以视为使用一张基本牌",
	["@rende-give"] = "你可以发动“仁德”",
	["~rende"] = "选择至少一张手牌→选择一名其他角色→点击确定",
	["jijiang"] = "激将",
        [":jijiang"] = "主公技，当你需要使用或打出一张【杀】时，你可以令其他蜀势力角色打出一张【杀】，视为你使用或打出之。",
	...
	["yijue"] = "义绝",
        [":yijue"] = "出牌阶段限一次，你可以与一名其他角色拼点：若你赢，其不能使用或打出手牌且其非锁定技无效直到回合结束；若你没赢，你可以令其回复1点体力。",
	...
	["tishen"] = "替身",
        [":tishen"] = "限定技，准备阶段，若你的体力值小于上回合结束时的体力值，你可以回复至上回合结束时的体力值，然后你摸X张牌（X为你以此法回复的体力值）。",
	["$TishenAnimate"] = "image=image/animate/tishen.png",

	["#zhugeliang"] = "迟暮的丞相",
	["zhugeliang"] = "诸葛亮",
	["illustrator:zhugeliang"] = "Kayak",
	["designer:zhugeliang"] = "Kayak",
	["guanxing"] = "观星",
	[":guanxing"] = "准备阶段，你可以观看牌堆顶的X张牌，然后以任意顺序置于牌堆顶或牌堆底（X为存活角色数且至多为5）。",
	["kongcheng"] = "空城",
	...
	["longdan"] = "龙胆",
	[":longdan"] = "你可以将一张【杀】当【闪】/【闪】当【杀】使用或打出。",
	["yajiao"] = "涯角",
	[":yajiao"] = "当你于回合外使用或打出手牌时，你可以展示牌堆顶的一张牌：若此牌与你使用或打出的手牌类别相同，你可以令一名角色获得之，否则你可以将之置入弃牌堆。",
	...
	["tieji"] = "铁骑",
	[":tieji"] = "当你使用【杀】指定目标后，你可以令目标角色的非锁定技无效直到回合结束并进行判定：若如此做，该角色须弃置一张与判定牌花色相同的牌，否则其不能使用【闪】响应此【杀】。",
	...
	["jizhi"] = "集智",
	[":jizhi"] = "当你使用一张锦囊牌时，你可以展示牌堆顶的一张牌：若此牌为基本牌，你选择一项：将之置入弃牌堆，或用一张手牌替换之；若此牌不为基本牌，你获得之。",
	...
	["zhuhai"] = "诛害",
	[":zhuhai"] = "一名其他角色的结束阶段，若该角色本回合造成过伤害，你可以对其使用一张【杀】（无距离限制）。",
	["qianxin"] = "潜心",
        [":qianxin"] = "觉醒技，当你造成伤害后，若你已受伤，你失去1点体力上限，然后获得“荐言”。",
	["jianyan"] = "荐言",
	...
	["designer:sunquan"] = "Kayak",
	["zhiheng"] = "制衡",
        [":zhiheng"] = "出牌阶段限一次，你可以弃置任意数量的牌，然后摸等量的牌。",
	["jiuyuan"] = "救援",
        [":jiuyuan"] = "主公技，锁定技，若你处于濒死状态，其他吴势力角色对你使用【桃】的回复值+1。",
	["#JiuyuanExtraRecover"] = "%from 的“%arg”触发，将额外回复 <font color=\"yellow\"><b>1</b></font> 点体力",
	...
	["fenwei"] = "奋威",
        [":fenwei"] = "限定技，当一名角色的非延时锦囊牌指定了至少两名目标时，你可以令此牌对至少一名目标角色无效。",
	...
	["qinxue"] = "勤学",
        [":qinxue"] = "觉醒技，准备阶段，若你的手牌数比体力值多3（七人及以上游戏为2）或更多，你失去1点体力上限，然后获得“攻心”。",
	...
	["zhaxiang"] = "诈降",
        [":zhaxiang"] = "锁定技，当你失去1点体力后，你摸三张牌，若此时为你的回合，本回合，你可以额外使用一张【杀】，你使用红色【杀】无距离限制且此【杀】指定目标后，目标角色不能使用【闪】响应此【杀】。",

	["#luxun"] = "儒生雄才",
	["luxun"] = "界陆逊",
	["illustrator:luxun"] = "depp",
	["qianxun"] = "谦逊",
	[":qianxun"] = "当延时锦囊牌或其他角色使用的非延时锦囊牌生效时，若你是此牌的唯一目标，你可以将所有手牌扣置于武将牌旁。一名角色的回合结束时，你获得所有“谦逊牌”。",
	["lianying"] = "连营",
	[":lianying"] = "当你失去最后的手牌后，你可以令至多X名角色各摸一张牌。（X为你失去的手牌数）",
	...
	["illustrator:lvbu"] = "张帅",
	["wushuang"] = "无双",
        [":wushuang"] = "锁定技，当你指定【杀】的目标后，目标角色须使用两张【闪】抵消此【杀】。你指定或成为【决斗】的目标后，与你【决斗】的角色每次须连续打出两张【杀】。",
	["@wushuang-slash-1"] = "%src 对你【决斗】，你须连续打出两张【杀】",
	["@wushuang-slash-2"] = "%src 对你【决斗】，你须再打出一张【杀】",
	["liyu"] = "利驭",
	[":liyu"] = "当你使用【杀】对一名其他角色造成伤害后，该角色可以令你获得其一张牌：若如此做，视为你对由该角色选择的另一名角色使用一张【决斗】。",
	...
	["chuli"] = "除疠",
	[":chuli"] = "出牌阶段限一次，你可以弃置一张牌，并弃置一至三名互不为友方的其他角色各一张牌。以此法弃置黑桃牌的角色各摸一张牌。",
        [":chuli_p"] = "出牌阶段限一次，若你有牌，你可以选择至少一名势力各不相同的有牌的其他角色：若如此做，你弃置你与这些角色各一张牌，然后以此法弃置黑桃牌的角色摸一张牌。",
	["jijiu"] = "急救",
	...
	["wangzun"] = "妄尊",
	[":wangzun"] = "主公的准备阶段，你可以摸一张牌，然后主公本回合手牌上限-1。",
	["tongji"] = "同疾",
	...
	["yaowu"] = "耀武",
        [":yaowu"] = "锁定技，当你受到红色【杀】的伤害时，伤害来源选择一项：回复1点体力，或摸一张牌。",
	...
	["qiaomeng"] = "趫猛",
	[":qiaomeng"] = "当你使用黑色【杀】对一名角色造成伤害后，你可以弃置该角色装备区的一张牌：若此牌为坐骑牌，此牌置入弃牌堆时你获得之。",
	...
	["super_guanxing"] = "观星",
	[":super_guanxing"] = "准备阶段，你可以观看牌堆顶的五张牌，然后将任意数量的牌置于牌堆顶，将其余的牌置于牌堆底。",
	...
	["&super_caoren"] = "曹仁",
	["super_jushou"] = "据守",
	[":super_jushou"] = "结束阶段，你可以摸X张牌，然后将武将牌翻面。",
	...
	["gdjuejing"] = "绝境",
        [":gdjuejing"] = "锁定技，摸牌阶段，你不摸牌。当你的手牌数变化后，若你的手牌数不为4，你须将手牌补至或弃置至四张。",
	["#GdJuejing"] = "%from 的“%arg”触发，摸牌阶段不摸牌",
	["gdlonghun"] = "龙魂",
	[":gdlonghun"] = "你可以将一张牌按以下规则使用或打出：红桃当【桃】；方块当【火杀】；黑桃当【无懈可击】；梅花当【闪】。准备阶段，若其他角色的装备区内有【青釭剑】，你可以获得之。",
