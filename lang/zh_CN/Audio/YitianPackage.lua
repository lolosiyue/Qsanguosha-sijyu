...
-- CV&Designer
	...
	["~yt_shencaocao"] = "月明星稀，乌鹊南飞，绕树三匝，无枝可依……",

	["designer:ca0chong"] = "太阳神上",
	["illustrator:ca0chong"] = "三国志大战",
	["cv:ca0chong"] = "神马芯",
	["$ytchengxiang1"] = "置象舟上，刻其水痕所至。", --发动技能
	["$ytchengxiang2"] = "称物载之，则校可知矣。", --恢复体力
	["$conghui1"] = "吾虽年幼，智意所及，有若成人。",
	["$zaoyao1"] = "咳咳咳……",
	["$zaoyao"] = "咳咳咳……",
	["~ca0chong"] = "仓舒，仓舒啊……", -- 曹操的声音
	...
	["cv:caizhaoji"] = "妙妙",
	["$guihan1"] = "雁南征兮欲寄边心，雁北归兮为得汉音。",
	["$caizhaoji_hujia1"] = "北风厉兮肃泠泠。胡笳动兮边马鸣。",
	...
	["cv:zhanggongqi"] = "喵小林",
	["$ytyishe1"] = "吾当作义舍，米肉置其中。", --放米
	["$ytyishe2"] = "信吾教义者，当量腹取足。", --给米
	["$ytyishe3"] = "汝今有异志，吾不欲助汝。", --拒绝给米
