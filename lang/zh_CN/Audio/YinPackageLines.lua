...
return {
	...
	--OL孙亮
	["$olkuizhu1"] = "子通专恣，必谋而诛之！",
	["$olkuizhu2"] = "孙綝久专，不可久忍，必溃诛！",
	["$olchezheng1"] = "风驰电掣，政权不怠。",
	["$olchezheng2"] = "唉~廉平掣政，实为艰事。",
	["$ollijun1"] = "立于朝堂，定于军心。",
	["$ollijun2"] = "君立于朝堂，军侧于四方。",
	
	--王基
	["$qizhi1"] = "声东击西，敌寇一网成擒！",
	["$qizhi2"] = "吾意（吴懿）不在此地，已遣别部出发。",
	["$jinqu1"] = "建上昶水城，以逼夏口！",
	...
	--OL卢植
	["$olmingren1"] = "得义真所救，吾任之必尽瘁以报！",
	["$olmingren2"] = "吾之任，君之明举。",
	["$olzhenliang1"] = "风霜以别草木之性，危乱而见贞良之节。",
	["$olzhenliang2"] = "贞节贤良，吾之本心。",
}